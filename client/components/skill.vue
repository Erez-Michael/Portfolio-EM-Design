        ...
        <div class="container">
            <div class="grid grid-cols-1" data-aos="fade-up">
                <div class="text-center">
                    ...
                    <p class="mt-5 text-gray max-w-[708px] mx-auto">Blending digital, graphic, and spatial creativity, we shape leading brand experiences that resonate with purpose.</p>
                </div>
            </div>
