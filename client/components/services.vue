<template>
    <!-- Start Services -->
    <section class="py-16 md:py-36  text-white bg-gradient-to-b from-purple/[10%] to-white dark:bg-gradient-to-b dark:from-purple/[10%] dark:to-transparent" id="services">
        <div class="container">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 mt-14 gap-7">
                <div class="border-2 border-gray/[12%] p-7 space-y-5 bg-gradient-to-b from-white/[4%] to-transparent" data-aos="fade-up">
                    <div>
