<template>
  ...
  <div class="flex flex-wrap lg:flex-nowrap items-stretch " data-aos="fade-up">

    <!-- Ludmer Engineering -->
    <div class="order-2 p-10 md:p-12 lg:flex-1 lg:order-1">
      <p class="text-[#4588cb] text-[22px] font-bold">Ludmer Engineering - Quebec</p>
      <a href="#" class="font-bold text-2xl/normal md:text-3xl/normal lg:text-[40px]/normal inline-block mt-5">
        Where contractors go for efficient design
      </a>
  ...
  <div class="flex flex-wrap lg:flex-nowrap items-stretch" data-aos="fade-up">
    <div class="order-2 p-10 md:p-12 lg:flex-1 lg:order-1">
      <p class="text-[#72043f] text-[22px] font-bold">Duchesnay - Canada</p>
      <a href="#" class="font-bold text-2xl/normal md:text-3xl/normal lg:text-[40px]/normal inline-block mt-5">
      ...
      <!-- <div class="flex items-center gap-4 mt-5 md:mt-8">
        ...
        <div class="border-2 border-gray/[14%] h-14 w-14 rounded-full flex items-center justify-center">
          <img src="@/assets/images/sketch-ex.svg" alt="Sketch Icon">
        </div>
      </div> -->
      <div class="inline-block mt-8">
  ...
  <div class="flex flex-wrap lg:flex-nowrap items-stretch" data-aos="fade-up">
    <div class="order-2 p-10 md:p-12 lg:flex-1 lg:order-1">
      <p class="text-[#079779] text-[22px] font-bold">Analog Pharma - Canada</p>
      <a href="#" class="font-bold text-2xl/normal md:text-3xl/normal lg:text-[40px]/normal inline-block mt-5">
...
<!-- Sefon Surfboards -->
  <div class="flex flex-wrap lg:flex-nowrap items-stretch" data-aos="fade-up">
    <div class="order-2 p-10 md:p-12 lg:flex-1 lg:order-1">
      <p class="text-[#198da4] text-[22px] font-bold">Sefon Surfboards - Peru</p>
      <a href="#"  class="font-bold text-2xl/normal md:text-3xl/normal lg:text-[40px]/normal inline-block mt-5">
        Unlock the Mysteries of Fun and Strategy
      </a>
      <p class="text-gray max-w-[420px] mt-3 md:mt-5">Contrary to popular belief, Lorem Ipsum is not simply random text.</p>
