...
<template>
  <!-- Start Testimonial -->
  <section class="py-16 md:py-36 client-review bg-gradient-to-b from-purple/[10%] to-white dark:bg-gradient-to-b dark:from-purple/[10%] dark:to-transparent" id="testimonials">
    <div class="container">
