<template>
    <transition @before-enter="beforeEnter" @enter="enter" @leave="leave">
      <div v-if="visible" @click="scrollToTop"
        :class="buttonClasses"
        class="fixed left-[90%] md:left-[95%] transform -translate-x-1/2 bg-gradient-to-b from-primary-gray2 to-transparent p-2 rounded-full text-primary-black2 text-4xl lg:text-3xl flex items-center justify-center w-[1.25em] md:w-[1.65em] lg:w-[1.95em] h-[1.6em] md:h-[2em] lg:h-[2.4em] cursor-pointer">
